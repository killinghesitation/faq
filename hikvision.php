<!DOCTYPE html> 
  ...
  <body>
    <div class="container-fluid">
      ...
      <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul id="top" class="nav navbar-nav">
            ...
            <li class="active"><a href="hikvision.php">Hikvision</a></li>
            <li><a href="dahua.php">Dahua</a></li>
            <li><a href="other.php">Другие вопросы</a></li>
          </ul>
        </div>
      </nav>
      <!--END NAVBAR-->
      ...
      <h2>Hikvision</h2>          
      <?php 
      include("display_questions_hik.php"); 
      ?>

      <?php 
      include("formcode_hik.php");
      ?>
        <div id="bot"></div>
        <div class="draqon"> 
