<!DOCTYPE html> 
  ...
  <body>
    ...
    if(!empty($_POST) )
    {
      ...
      $query = "
      INSERT INTO `support`.`other_questions` (`Vopros`, `Otvet`) VALUES ('$vopros', '$otvet')";
      mysql_query($query);
      
      echo '<h1>Вопрос отправлен в базу данных! </h1>';
      echo '<h2><a href="other.php"><span class="glyphicon glyphicon-circle-arrow-left"></span>Написать еще</a></h2>';
    }
    ?>
    </div>
  </body>
